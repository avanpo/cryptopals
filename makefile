...
set5: set5.c libs/ciphers.c libs/macs.c libs/pk.c libs/random.c libs/utils.c
	$(CC) $(CFLAGS) $(LIBS) -o set5 set5.c libs/ciphers.c libs/macs.c libs/pk.c libs/random.c libs/utils.c
